...
function EarlyReturn(props: { error: any }) {
    ...
    const handleButtonClick = useCallback<Parameters<typeof Button>[0]["onClick"]>(() => setCount(count + 1), [count]);
    if(props.error) {
...
const ButtonStyle: Parameters<typeof Button>[0]["style"] = { padding: '10px' };
